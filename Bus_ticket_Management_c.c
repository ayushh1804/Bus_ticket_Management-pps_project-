...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Volvo super express","Tata Travels","Tia Travels","Hans Travels","Yan Express","State Travel Board"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
printf("\n\n");
    printf("======================================================================================================\n");
 printf("\t\t\t\tYour money has been credited to your account.\t\t\t\n");
    printf("======================================================================================================\n");
}
